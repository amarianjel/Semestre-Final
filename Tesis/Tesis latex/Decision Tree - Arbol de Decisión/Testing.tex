...
\par Respecto al ACV, el modelo identifico a 5 pacientes que posee un buen pronóstico (estable) y 5 paciente que posee un pronóstico no tan favorable, según la variable objetivo detallada en \ref{crear-columna-para-nihss_alta_estable_o_grave}. Así mismo, el modelo identifica a 1 paciente que poseen buen pronóstico, pero en realidad poseen mal pronóstico, y a su vez, el modelo identifica a 1 paciente que poseen mal pronóstico, pero en realidad poseen buen pronóstico.\\
...
\end{table}
	...
	En la tabla \ref{tab:clasificacion dt}, se observa para interpretación como ejemplo la tupla número 4. Esta tupla no pertence al estado 0, por ende, en términos de ACV, el paciente número 4 no tiene un pronóstico favorable. 
\par Recordamos que la Matriz de Confusión \ref{fig:mctdt} poseía 5 pacientes que tenian un pronóstico menos favorable, ellos son los que se registran con el valor 1 en la columna 0 de la tabla.
...
Número de columna para el 95 \% de importancia: 4
    ...
    En la Figura \ref{fig:ipadt} de importancia acumulada, la curva se dispara con la ``GLUCOSA\_cat'' , ratificandosé con el resultado del 95\% de importancia medido anteriormente.\\

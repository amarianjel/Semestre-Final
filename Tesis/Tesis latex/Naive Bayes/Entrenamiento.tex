...
cada atributo se estima independientemente \cite{Mosquera2018}.
...
\begin{center}
    	\begin{figure}[H]
	\centering
    \adjustimage{max size={0.5\linewidth}{0.9\paperheight}}{Naive Bayes/output_91_0.png}
	\caption{Matriz de confusión de entrenamiento Naive Bayes}
	\label{fig:mcenb}
	\end{figure}
\end{center}
    
    En la matriz de confusión \ref{fig:mcenb} (1 , 1) podemos observar el resultado en el
